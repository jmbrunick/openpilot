...
========================
* Reverted the climb-to-MAX / climb-sustain stack (#145, #147) for driveability — those handoffs surged / pulsed. Post-engage is back to **#143 last-pressed pedal hold** (1 s). Engage handoff will be revisited on a different path. Locationd safety unchanged. Same as nap-dev.
