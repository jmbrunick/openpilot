...
Writes go only through Params (and SL/FAI helpers). This module is the
settings API — no cruise-trim injector, and no Philip-only City Turns /
Tap LC / Corner Assist / Lane Centering.

Hypermile is nap-dev-only and is not exposed here.
"""
...
REJECTED_SETTING_NAMES = frozenset({
  ...
  "hypermile",
  "hypermile_step_down",
  "hypermile_hill_climb",
  "naphypermile",
  "naphypermilestepdown",
  "naphypermilehillclimb",
})
...
def _api_name(name: str) -> str:
  ...
  if folded in REJECTED_SETTING_NAMES or key in REJECTED_SETTING_NAMES:
    raise SettingError(f"rejected setting: {key}")
...
def setting_catalog() -> list[dict[str, Any]]:
  ...
  return [
    {"name": "accel", "param": PARAM_ACCEL, "section": "mannerisms",
     "label": "Acceleration", "kind": "int", "min": 1, "max": 10},
    {"name": "adaptive_accel", "param": PARAM_ADAPTIVE_ACCEL, "section": "mannerisms",
     "label": "Adaptive Accel", "kind": "bool"},
    {"name": "follow_distance", "param": PARAM_FOLLOW_DISTANCE, "section": "mannerisms",
     "label": "Follow Distance", "kind": "int", "min": 1, "max": 7},
    {"name": "driver_lat_handoff", "param": NAP_DRIVER_LAT_HANDOFF, "section": "mannerisms",
    ...
    {"name": "map_speed_offset_mph", "param": PARAM_MAP_OFFSET, "section": "map_speed",
     "label": "Map Speed Offset", "kind": "choice",
     "values": [-5, 0, 5], "choices": ["-5 mph", "0", "+5 mph"]},
    {"name": "map_speed_lookahead", "param": PARAM_MAP_LOOKAHEAD, "section": "map_speed",
     "label": "Lookahead", "kind": "choice",
     "choices": ["Off", "Late", "Normal", "Early"]},
    ...
    {"name": "experimental", "param": PARAM_EXPERIMENTAL, "section": "stock",
     "label": "Experimental Mode", "kind": "bool"},
