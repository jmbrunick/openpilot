...
History (on-car):
  ...
  #84  hands-off confirm 0.25 s before the 1 s blend (crossover gap)
  now  hands-off confirm 0.15 s before the 1 s blend
...
# Shorter than the 0.25 s gap; still longer than the old 0.08 s snatch.
