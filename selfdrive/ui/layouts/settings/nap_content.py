...
SPEED_SIGN_LOG_DESCRIPTION = (
  ...
  "process timeouts. Heavy detect never runs while NAP or cruise is engaged "
  "(plate shows WAIT). Collect signs parked, disengaged, or Force Offroad. "
  "Disengaged detect is 1 Hz and nice 19. If you see TAKE CONTROL or "
