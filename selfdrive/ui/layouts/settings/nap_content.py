...
WIPER_COLLAR_DESCRIPTION = (
  ...
  + "(err=not_installed / no_tesla_can / exception:* if TX is dead). "
  + "candump src 0 is the live stalk (stays 0 if Off). src 128 is our TX. "
  + "Car on, Force Offroad off — card must be running. Panda already "
  + "allows 0x45 while disengaged (same as NAP Int extra-forward); no "
  + "engage required. Default Off. Leave Wiper Control Off while testing; "
