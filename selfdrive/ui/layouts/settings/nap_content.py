...
DM_SIMULATE_LOOKING_DESCRIPTION = (
  ...
  + "head-pose, eye, or phone alerts. Mutually exclusive with False "
  + "Alert Ignore: turning this On turns that Off. Not a mute: stock "
  + "DM still runs. Hands-on ≥ 2, stalk cancel, door, and reverse still "
  + "hard-cancel. Always-on DM when not engaged is unchanged. Turn Off "
  + "for no simulated glance."
)
DM_FALSE_ALERT_IGNORE_DESCRIPTION = (
  "Default Off. While engaged, ignore false phone/device distraction "
