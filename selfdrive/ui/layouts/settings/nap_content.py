...
DM_SIMULATE_LOOKING_DESCRIPTION = (
  ...
  + "look-at-road timer has counted down about 1 s, simulate a glance "
  + "if the camera lost the face or is uncertain — same attentive path "
...
DM_FALSE_ALERT_IGNORE_DESCRIPTION = (
  ...
  + "distraction (phoneProb) on the same random 1–3 s cadence as "
