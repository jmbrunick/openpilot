...
- `selfdrive/controls/tests/test_tesla_preap_brake_cancel_regen.py` — tip-brake speed-target glide vs hold/firm RELEASE
- `opendbc_repo/opendbc/car/tesla/preap/brake_tip_glide.py` — tip/hold classifier + speed-target glide
- `opendbc_repo/opendbc/car/tesla/preap/tests/test_brake_tip_glide.py` — tip vs hold + glide physics
