...
12. **Reverse while engaged:** session ends (not a pause). No take-control-immediately alarm — OP just goes off. After Drive a normal double SET must engage without Controls Mismatch and without a prior on-device disable. Soft-lat / blinker / sticky MAX must not stay wedged.
