...
- `selfdrive/controls/tests/test_tesla_preap_one_pedal_long.py` — One-Pedal Long pause latch + RELEASE regen (gas→lift keeps enableLongControl/longActive off until SET; kick-miss still latches; engage-while-gas still ACQUIREs; no USER_DISABLE)
