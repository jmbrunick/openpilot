...
**Hypermile (nap-dev, default Off):** Settings → NAP → Driving Mannerisms. While On and a radar lead is present, stalk up/down steps Hypermile follow 1–5 (closer/farther) instead of MAX. No lead: stalk still adjusts MAX. See [hypermile.md](hypermile.md). Soft-lat / DM / blinker / sticky MAX / one-SET / standstill gas-gate / reverse hard-cancel unchanged.
