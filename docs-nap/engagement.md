...
- `opendbc_repo/opendbc/car/tesla/preap/carcontroller.py` — pedal TX, engage grace, gas-lift VDAS seed, tip-cancel regen ramp
- `opendbc_repo/opendbc/car/tesla/preap/brake_cancel_regen.py` — tip vs hold brake-cancel (ramp 0 → stock regen, then RELEASE)
