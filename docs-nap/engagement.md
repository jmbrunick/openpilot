...
- `selfdrive/controls/tests/test_tesla_preap_one_pedal_long.py` — One-Pedal Long pause latch + RELEASE regen (lift does not ACQUIRE; SET does; no USER_DISABLE)
