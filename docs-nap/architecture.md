...
**Default Off** (`NAPDriverLatHandoff=0`). Gravel/crosswind false-yield grays 3X chrome and drops lat authority. Do not enable for driving. See [engagement.md](engagement.md#driver-wheel-temporary-lateral-handoff).
