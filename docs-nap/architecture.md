...
Behind a radar lead, a Pre-AP stalk **tip** (1 mph) writes stock Follow Distance 1–7 (`NAPFollowDistance`) and undoes that frame’s MAX; a **full press** (5 mph) still steps MAX +5/−5 — Hypermile On or Off. The Driving Mannerisms slider stays visible and updates live. No lead: tip and hold both still step MAX. Hypermile does not own follow levels. See [hypermile.md](hypermile.md) and [engagement.md](engagement.md).
