...
Simulate Look-at-Road (`NAPDmSimulateLooking`) defaults **On**. While engaged, after ~1 s of DM countdown, a simulated glance on the stock looking-path resets awareness on a random **2–3 s** interval. Not a mute. Turn **Off** for stock DM.
