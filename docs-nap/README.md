...
- **[engagement.md](engagement.md)** — stalk FSM, pedal-vs-no-pedal engagement paths, brake behavior, driver-wheel lateral handoff (default On; firmer 0.85 Nm / 250 ms; Settings can disable)
