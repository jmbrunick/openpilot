...
- **[nap-dash.md](nap-dash.md)** — lean companion Dash on `:7070` (Params + `/api/software` only; no high-rate sockets). Optional process. Flash `cursor/nap-dash-lite-36e3`. Do not merge until Justin confirms.
