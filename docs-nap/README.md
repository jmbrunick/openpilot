...
- **[engagement.md](engagement.md)** — stalk FSM, pedal-vs-no-pedal engagement paths, brake behavior, driver-wheel lateral handoff (default On; 0.70 Nm / 140 ms; stay yielded while handsOnLevel ≥ 1; Settings can disable)
